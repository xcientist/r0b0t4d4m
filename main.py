...
Robotadamopen = ["hey robotadam","hey","alo","robot","açıl","açıl susam açıl","açın"]
...
def robotadam(media, utility, data):
        ...
        if len(data[data.Saat == str(ctime().split(" ")[3][:-3])]) > 0:
            ...
            if datax in robotadamopen:
                ...
                if datax in kapatma:
                    ...
                    robotadam(mediamodule, utilitymodule, datax)