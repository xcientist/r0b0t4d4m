...
class Features:
    ...
    def mapfeature(self, data):
        ...
        self.mediamodule.speak("Bekle ercan Sana " + location + " in nerede olduğunu göstereceğim")
        driver = webdriver.Chrome(
            'C:/Users/ercan/Desktop/chromedriver.exe')  # Optional argument, if not specified will search path.
    ...
    def playyoutube(self, data):
        ...
        self.mediamodule.speak("Bekle ercan Senin için " + parcaismi + " yi çalıyorum")
        driver = webdriver.Chrome('C:/Users/ercan/Desktop/chromedriver.exe')
